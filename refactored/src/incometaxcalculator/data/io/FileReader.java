...
public abstract class FileReader {
  ...
  protected int checkForReceipt(BufferedReader inputStream)
    ...
    while (!isEmpty(line = inputStream.readLine())) {
      ...
      receiptId = checkForFileType(values);
    }
    return receiptId;
  }

  protected abstract int checkForFileType(String[] values);
  
  protected abstract String getValueOfFieldPerFileType(String [] values);
  ...
  protected String getValueOfField(String fieldsLine) throws WrongFileFormatException {
    ...
    try {
      ...
      return getValueOfFieldPerFileType(values);
